...
export const BASENAME = "/sharktank";
const REDIRECT_PATHNAME_KEY = "sharktank__pathname";
const REDIRECT_SEARCH_KEY = "sharktank__search";
const REDIRECT_HASH_KEY = "sharktank__hash";
